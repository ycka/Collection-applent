    ...
    <view>
        <van-cell-group>
            ...
            <view v-show="submitData.aav001=='1'">
                <check-radius top title="是否已脱贫" @set-param="e=>submitData.aav002=e" actions="aav002"></check-radius>
            </view>
            ...
            <view v-show="submitData.aav017=='1'">
                <check-radius top title="是否已转非农" @set-param="e=>submitData.aav018=e" actions="aav018"></check-radius>
            </view>
            ...
            <view v-show="submitData.aav005=='03'">
                ...
                <view v-show="submitData.aav015=='1'">
                    <check-checkbox title="具体就业意向" @set-param="e=>submitData.aav016=e" actions="aav016"></check-checkbox> 
                </view>
